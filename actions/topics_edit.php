...
<div class="row">
    ...
    <div class="col-lg-7">
        <div class="mb-3">
            ...
            <input value="<?php echo $topic_row['topic_title'] ?>" type="text" class="form-control" id="topicTitle"
                required>
        </div>
        <div class="mb-3">
            <label for="expireDateTime" class="form-label">Close Time</label>
            <input value="<?php echo $topic_row['expire_datetime'] ?>" type="text" class="form-control"
                id="expireDateTime" required>
        </div>
        <div class="mb-3">
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <label
                            class="btn btn-outline btn-outline-dashed btn-active-light-primary p-3 d-flex align-items-center gap-2">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text text-muted">เปิดใช้งานเพื่อให้ทุกคนสามารถดูหน้า Monitor ได้โดยไม่ต้องล็อกอิน
                    </div>
                </div>
            </div>
        </div>
